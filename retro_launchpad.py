...
storage format implemented in cassette.py: listen to a tape (real
hardware, or a WAV file for testing), reassemble an Atari 2600 ROM, and
launch it straight into RetroArch (Stella core).

INSTALLATION
------------
Drop this file AND cassette.py into your RetroArch install directory
